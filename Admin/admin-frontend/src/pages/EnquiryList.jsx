...
export default function EnquiryList() {
    ...
    return (
        <div className="space-y-6 max-w-[1600px] mx-auto pb-12">
            ...
            {dateError && (
                <div className="p-3 bg-brand-danger/10 border border-brand-danger/30 rounded-xl flex items-center gap-2 text-[13px] font-medium text-brand-danger">
            ...
            <div className="acx-card p-4 flex flex-col md:flex-row md:items-center gap-4">
                <div className="relative flex-1 min-w-[200px]">
                    ...
                    <input 
                        ...
                        className="acx-input pl-11 w-full text-sm h-11"
                    />
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <select 
                        ...
                        className="acx-input w-auto min-w-[140px] text-sm appearance-none cursor-pointer h-11 pr-8"
                    >
                    ...
                    <input 
                        ...
                        className="acx-input w-32 text-sm hidden lg:block h-11"
                    />
                    ...
                    <div className="flex items-center space-x-2">
                        <input 
                            ...
                            className={`acx-input w-36 text-sm h-11 ${dateError ? 'border-[#DC2626]' : ''}`}
                            title="From Date"
                        />
