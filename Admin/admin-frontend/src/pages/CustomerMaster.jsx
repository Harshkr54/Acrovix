...
export default function CustomerMaster() {
    ...
    return (
        <div className="space-y-6 max-w-[1600px] mx-auto pb-12">
            ...
            {/* Form Drawer / Card */}
            {showForm && (
                <div className="card p-6 border border-[#14B8A6]/20 mb-6 relative overflow-hidden">
                    ...
                    <h2 className="text-[16px] font-bold text-text-primary mb-6 flex items-center tracking-tight">
                        <UsersRound className="w-5 h-5 mr-2 text-[#14B8A6]" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input required type="text" value={formData.customerCode} onChange={e => setFormData({...formData, customerCode: e.target.value})} className="input-field rounded-xl text-[13px] bg-bg-main h-11" placeholder="CUST-001" disabled={editingId !== null} />
                            </div>
                            <div>
                                <label className="block text-[11px] font-bold text-text-muted uppercase tracking-wider mb-2">Contact Name</label>
                                <input required type="text" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} className="input-field rounded-xl text-[13px] bg-bg-main h-11" placeholder="John Doe" />
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" value={formData.companyName} onChange={e => setFormData({...formData, companyName: e.target.value})} className="input-field pl-9 rounded-xl text-[13px] bg-bg-main h-11" placeholder="Acme Corp" />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input required type="email" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} className="input-field pl-9 rounded-xl text-[13px] bg-bg-main h-11" placeholder="john@acme.com" />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" value={formData.phone} onChange={e => setFormData({...formData, phone: e.target.value})} className="input-field pl-9 rounded-xl text-[13px] bg-bg-main h-11" placeholder="+1 234 567 890" />
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea value={formData.billingAddress} onChange={e => setFormData({...formData, billingAddress: e.target.value})} className="input-field rounded-xl text-[13px] bg-bg-main min-h-[80px] p-3" placeholder="Enter billing address..."></textarea>
                            </div>
                            <div>
                                <label className="block text-[11px] font-bold text-text-muted uppercase tracking-wider mb-2">Shipping Address</label>
                                <textarea value={formData.shippingAddress} onChange={e => setFormData({...formData, shippingAddress: e.target.value})} className="input-field rounded-xl text-[13px] bg-bg-main min-h-[80px] p-3" placeholder="Enter shipping address..."></textarea>
                            </div>
                        </div>
                        <div className="pt-2 flex justify-end">
                            <button type="submit" className="btn-primary px-8 py-2.5 text-[13px] font-semibold shadow-[0_4px_14px_rgba(20,184,166,0.25)] bg-[#0D9488] hover:bg-[#0F766E] border-transparent">
                                ...
                                <tr>
                                    <td colSpan="5" className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center justify-center space-y-4 max-w-sm mx-auto">
                                            ...
                                            <button onClick={fetchCustomersList} className="btn-primary mt-2">
                                    ...
                                    <tr key={c.id} className="hover:bg-bg-hover transition-colors group">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap align-top text-right">
                                            <button 
                                                ...
                                                className="text-[12px] font-semibold text-[#14B8A6] hover:text-[#0D9488] transition-colors mr-4"
                                            >
                                                Edit
                                            </button>
                                            <button 
